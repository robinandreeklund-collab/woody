...
DEVICE_CATALOG = [
    ...
    ("laser_red",  "Linjelaser RÖD",        "650 nm · 100 mW · 60°",           "5 V · GPIO-enable",    "laser"),
    ("laser_green","Linjelaser GRÖN",       "520 nm · 50 mW · 60°",            "24 V · GPIO-enable",   "laser"),
    ("led_white",  "LED-belysning",         "24 V vit linjelist",              "GPIO-enable",          "light"),
    ("photocell",  "Fotocell · anslag",     "GTRIC LSZ-S30N1 · NPN diffus",    "GPIO in",              "sensor"),
