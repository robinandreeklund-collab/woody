...
BOM = [
    ...
    ("Bandpass 650", "650 nm bandpass FRONT-mont (smal, FWHM ~10 nm, OD≥3)", 1, "isolerar röd laser; skruvas på 12 mm-linsens frontgänga", "—", "—", 200, 1, "AliExpress/MidOpt · att köpa"),
    ...
    ("Bandpass 520", "520 nm bandpass FRONT-mont (smal, FWHM ~10 nm; matcha 520, ej 532)", 1, "isolerar grön laser; skruvas på 12 mm-linsens frontgänga", "—", "—", 200, 1, "AliExpress/MidOpt · att köpa"),
