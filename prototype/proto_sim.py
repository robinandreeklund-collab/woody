...
BOM = [
    ...
    ("24→5V buck (röd laser)", "DC-DC buck 24→5V (≥2–3A) — röd 5V-laser från 24V-railen", 1, "röd linjelaser 5V; encodrar matas av RoboClaw-BEC, profilkameror via USB, Jetson egen matning (24V för högt)", "24V→5V", "≥2A", 30, 1, "att köpa"),
