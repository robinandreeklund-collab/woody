...
BOM = [
    ...
    ("Rullband ×2", "AliExpress mini-transportör 24 V, 50 mm/s, ~600 mm", 2, "matning (cross-feed) — verifiera att motor+PSU medföljer", "24 V DC", "50 mm/s", 736, 1),
    ("Motordrivare", "BTS7960 H-brygga (fram/back + PWM)", 1, "Jetson styr riktning+fart → multi-pass", "GPIO×2 + PWM", "—", 250, 1),
    ...
    ("NVMe SSD", "M.2 256–512 GB (Jetson-lagring)", 1, "OS + dataset + modeller", "M.2 (Jetson)", "—", 450, 1),
    ("Nätaggregat 24 V", "DIN/bordsnätagg ~5 A", 1, "rullband + motordrivare", "—", "—", 300, 1),
    ("Nätaggregat 5 V", "≥2 A (lasrar via MOSFET)", 1, "linjelasrar (CW)", "—", "—", 150, 1),
    ("MOSFET-moduler ×2", "logik-MOSFET (laser-enable)", 2, "GPIO 3,3 V → laser 5 V on/off", "GPIO", "—", 40, 1),
    ("Lasersäkerhet", "skyddsglasögon + skylt + skärm", 1, "Class 3R/3B-rutiner (650/520 nm)", "—", "—", 500, 1),
    ("Diverse", "USB3-kabel, dupont/terminal, fästen", 1, "—", "—", "—", 600, 1),
