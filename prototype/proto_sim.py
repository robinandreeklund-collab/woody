...
BOM = [
    ...
    ("Distributionsblock (rails)", "HL-PBB-2-16 fjäder-terminalblock, 2 bussar × 16: buss A = +24V, buss B = GND/STJÄRNJORD", 1, "central 24V- & jord-distribution SMPS→alla laster (din 'en kabel'-idé); buss B = gemensam stjärnjord (även Jetson-GND hit). Verifiera A-rating ≥ ~8A; grov tråd in, RoboClaw med ordentlig area", "—", "≥10A buss", 170, 1, "AliExpress · att köpa"),
    ...
    ("Enable röd laser (5V)", "NON-isolerad D4184 MOSFET-modul (DC 5–36V, 3,3V-trigg, PWM) — funkar på 5V (till skillnad från opto-AOD4184 ≥6V). Alt: liten AO3400-MOSFET. Lasern saknar TTL → bryt 5V-matningen (inline barrel-adapter, slipp klippa)", 1, "röd 5V-laser on/off; IN+←+5V(buck), IN−←GND, OUT→laser; PWM←GPIO. ICKE-isolerad → kräver gemensam jord (finns)", "GPIO", "on/off + PWM", 25, 1, "AliExpress · att köpa"),
