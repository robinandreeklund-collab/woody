...
BOM = [
    ...
    ("Motordrivare", "BTS7960 43 A H-brygga", 1, "Jetson styr riktning+fart → multi-pass", "GPIO×2 + PWM", "—", 80, 1),
    ("Encoder + mäthjul", "LPD3806-600BM (600 P/R) + mäthjul Ø64 mm", 1, "position (immun mot slir) + kameratrigger", "GPIO A/B + trig→kam", "~0,08 mm/puls", 250, 1),
    ("Ingångslaser", "E3F-DS30C4 fotocell (NPN, diffus)", 1, "registrerar brädans läge vid ingång (rullband)", "GPIO", "kant-trig", 80, 1),
