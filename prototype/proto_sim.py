...
BOM = [
    ...
    ("Bandpass 650", "650 nm bandpass M30.5×0.5 — MidOpt BN650-30.5 (el. AliExpress), OD≥3", 1, "isolerar röd laser; skruvas på 12 mm-linsens M30.5-gänga", "—", "—", 200, 1, "AliExpress/MidOpt · att köpa"),
