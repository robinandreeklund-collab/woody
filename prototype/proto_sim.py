...
BOM = [
    ...
    ("Bandpass 650", "650 nm bandpass Ø25/25,4 mm + C-mount-hållare (FWHM 10–25 nm)", 1, "isolerar röd laser; monteras vid C-mount (passar oavsett frontgänga)", "—", "—", 200, 1, "AliExpress/MidOpt · att köpa"),
    ...
    ("Bandpass 520", "520 nm bandpass Ø25/25,4 mm + C-mount-hållare (matcha 520, ej 532)", 1, "isolerar grön laser; monteras vid C-mount", "—", "—", 200, 1, "AliExpress/MidOpt · att köpa"),
