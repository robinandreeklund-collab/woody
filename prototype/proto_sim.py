...
BOM = [
    ...
    ("Rull-encoder band B (ref)", "E6B2-CWZ1X (RS-422 line-driver, MATA @ 5V) — Ø40 mm-hjul, samma PPR som A", 1, "band B → KAMERANS encoder A/B diff (IN1± pin3/4, IN2± pin5/6, native) + 26C32 → RoboClaw EN2; line-trigg", "→ kamera IN1±/IN2± + EN2", "12,6 µm/puls", 250, 1, "Omron · att köpa"),
    ("Diff→single encoder-modul", "färdig 'differential→single-ended' encoder-omvandlare (26C32-typ) m. inbyggd 5V/150mA DC-DC", 1, "band B diff → single-ended 0–5V → RoboClaw EN2 (sluter loop); 5V-DC-DC MATAR CWZ1X-encodern (=5V diff till kameran). Kameran tar diff direkt parallellt", "—", "5V ut", 120, 1, "AliExpress · ditt val"),
