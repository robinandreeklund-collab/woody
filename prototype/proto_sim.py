...
BOM = [
    ...
    ("Motorstyrning", "RoboClaw 2x7A (closed-loop, encoder-in + PID)", 1, "läser encodern + PID; Jetson kommenderar fart/läge", "UART/USB ↔ Jetson", "—", 800, 1),
    ("Magnetencoder", "AS5601 12-bit (4096/varv) på motoraxel + diametrisk magnet", 1, "KONTAKTLÖS position via motoraxeln; nollställs mot anslaget", "A/B → RoboClaw", "~0,02 mm/steg", 120, 1),
