...
# ===================== HÖGER: STYRKEDJA =====================
panel(880, 116, 800, 600, "STYRKEDJA — Jetson → 2× Jrk G2 → rullband", INK)
node(910, 175, 190, 120, "JETSON Orin Nano", "", JET)
txt(1005, 226, "I²C-buss (2 adresser)", 9.5, "middle", INK)
txt(1005, 244, "→ båda Jrk: målfart", 9, "middle", MUTED, 700, MONO)
txt(1005, 260, "in: fotcell (pin 22)", 9, "middle", MUTED, 700, MONO)
# två oberoende Jrk-loopar (en per band)
node(1230, 150, 200, 56, "JRK G2 #1 (band V)", "frekvens-FB", ORANGE); node(1490, 152, 90, 50, "MOTOR V", "", BLUE)
node(1230, 320, 200, 56, "JRK G2 #2 (band H)", "frekvens-FB", ORANGE); node(1490, 322, 90, 50, "MOTOR H", "", BLUE)
node(1250, 432, 180, 46, "Hall V & H 'Signal'", "inbyggd, 1-kanal/motor", PURP)
node(910, 360, 175, 50, "FOTCELL (valfri)", "E3F-DS30C4", RED)
node(1095, 432, 120, 46, "24 V-PSU", "motorström", "#c89028")
wire(1100, 215, 1230, 178, "I²C", JET); wire(1100, 250, 1230, 348, "I²C", JET)
wire(1430, 178, 1490, 177, "M+/M−", ORANGE); wire(1430, 348, 1490, 347, "M+/M−", ORANGE)
arrow(1300, 432, 1300, 376, PURP, 1.8); txt(1308, 410, "Signal V/H (FB)", 8.5, "start", PURP, 700, MONO)
arrow(1155, 432, 1240, 206, "#c89028", 1.6); txt(1120, 410, "24 V", 9, "end", "#c89028", 700, MONO)
wire(1085, 385, 1010, 295, "pin 22", RED)
txt(1235, 252, "2 OBEROENDE fart-loopar → inget slir-beroende", 8.5, "start", INK, 700)
gy = 560; L(940, gy, 1620, gy, INK, 2.2); txt(944, gy - 8, "GEMENSAM GND (Jetson ↔ båda Jrk ↔ 24 V-PSU ↔ motorernas Signal-GND) — KRITISKT", 9.5, "start", INK, 700)
for gx, y0 in ((1005, 295), (1155, 478), (1640, 202)): L(gx, y0, gx, gy, INK, 1, "3 3")
