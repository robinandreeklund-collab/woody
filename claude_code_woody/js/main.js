/* ============================================================
   main.js — flerbrädskö, sidledsmatning, takt↔upplösning.
   ============================================================ */
(function () {
  const N = 11;
  ...
  const state = {
    channel: 0, overlay: 1, distort: 0, trigger: 0,
    takt: 60,                  // brädor/min
    pitch: 0.35,               // medbringaravstånd (wu)
    widthWu: 125 / (5400 / 7), // brädbredd (wu) ≙ 125 mm
    lengths: [3.0, 2.7, 2.4],  // tillåtna kaplängder (m)
    cutOverlay: 1,             // sågplan-overlay på brädan
    time: 0, playing: true,
    showUnder: true, showXray: true, dispScale: 1,
  };
  ...
  const feedWorld = () => state.pitch * state.takt / 60;        // wu/s (brädor passerar = takt)
